...
const driverName = "sohustorage"

// minChunkSize defines the minimum multipart upload chunk size
const minChunkSize = 5 << 20
const defaultChunkSize = 2 * minChunkSize

// listMax is the largest amount of objects you can request from sohustorage in a list call
const listMax = 1000
...
// sohuStorageDriverFactory implements the factory.StorageDriverFactory interface
type sohuStorageDriverFactory struct{}

func (factory *sohuStorageDriverFactory) Create(parameters map[string]interface{}) (storagedriver.StorageDriver, error) {
